...
<nav class="navbar navbar-expand-lg navbar-light fixed-top">
	...
	<?php
	$id = $_GET['id'];
	echo "<h2> O livro a remover é o $id. </h2>";
	?>
<?php
    ...
    //Intrução SQL para eliminar da base de dados
    $querySQL = "DELETE FROM livros WHERE codlivro=$id";

    if (mysqli_query($conn, $querySQL)) {
        echo "<p>Registo apagado com sucesso</p>";
      } else {
        echo "<p>Erro ao eliminar o registo: " . mysqli_error($conn)."</p>";
      }
